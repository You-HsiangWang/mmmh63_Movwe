...
// sql語法
if($forumtitle == '' || $forumtype == '' || $forumpic == '' || $forumcontent == ''){
    $output['code'] = '401';
...
$forumsql = 'INSERT INTO `forum`(`forum_title`, `forum_content`, `forum_pic`, `forum_type`, `forum_clicks`, `forum_uploadtime`, `forum_arthur`) VALUES (?,?,?,?,?,?,?)';
$forumstmt = $pdo->prepare($forumsql);
$forumstmt->execute([$forumtitle, $forumcontent, $forumpic, $forumtype, $forumclicks, $forumdate, $forumarthur]);
