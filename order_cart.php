            ...
            <div class="text__container">
                ...
                <div class="progress-bar d-flex justify-between align-item-center mt-80">
                    <div class="d-flex justify-center align-item-center">
                        ...
                        <h3 class="ml-10" style="color: #10FFA2;">購物車</h3>
                    </div>
                    ...
                    <div class="d-flex justify-center align-item-center">
                        <svg width="26" height="25" viewBox="0 0 26 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M14.1333 18.5V15.732H8.98134V14.788L13.7973 7.94H15.4133V14.628H17.2853V15.732H15.4133V18.5H14.1333ZM10.3413 14.628H14.1333V10.676C14.1333 10.3987 14.1387 10.116 14.1493 9.828C14.1707 9.54 14.1867 9.25733 14.1973 8.98H14.1653C14.0373 9.24667 13.872 9.54533 13.6693 9.876C13.4667 10.2067 13.28 10.4947 13.1093 10.74L10.3413 14.628Z"
                                fill="#FFFFFD" />
                ...
                <div class="mt-10 border-bottom-main-color pb-10" id="cartInfo">
                    <p class="white">購物車內商品
                        <svg class="ml-10" width="6" height="10" viewBox="0 0 9 15" fill="none"
                    ...
                    <table>
                        <tr class="yellow">
                            <th class="d-flex justify-center align-item-center">
                                <label>
                                    <input type="checkbox" class="checkitem" hidden>
                                    <span>
                                        <svg width="14" height="10" viewBox="0 0 21 15" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g clip-path="url(#clip0_1427_26028)">
                                                <path
                                                    d="M20.5616 0.440204C21.1476 1.02621 21.1476 1.97318 20.5616 2.55919L8.56031 14.5605C7.97431 15.1465 7.02733 15.1465 6.44133 14.5605L0.439361 8.55984C-0.146454 7.97384 -0.146454 7.02686 0.439361 6.44086C1.02527 5.85486 1.97506 5.85486 2.56106 6.44086L7.45863 11.3773L18.4426 0.440204C19.0287 -0.146735 19.9756 -0.146735 20.5616 0.440204Z"
                                                    fill="#fff" />
                                            </g>
                                            <defs>
                        ...
                        <tr id="text">
                            ...
                            <td>
                                <div class="d-flex justify-center">
                                    <button class="button-number button-number-minus mr-10"
                                        onclick="subFunction()">-</button>
                                    <input type="text" value="1" id="quantity">
                                    <button class="button-number button-number-plus ml-10"
