                    ...
                    <div class="account">
                        <div class="account-left">
                            ...
                            <div class="account-name">
                                <?php echo $_POST['acc_nickname'];
                                ?>
                            </div>                        
                        </div>
                        <div class="account-info">
                            <?php echo $_POST['acc_intro'];
                            ?>
                        </div>
                                            ...
                                            <?php foreach ($HLrow as $HLrowinfo) : ?>
                                                <div class="image__card">
                                                    <div class="imge__card__information">
                                                        ...
                                                        <div class="information__top">
                                                                    <img class="information__video"
                                                                        src="./videodb/video/<?= $HLrowinfo['video_poster_hor'] ?>" alt="">
                                                        </div>
                                    ...
                                    <div class="info_gen01">
                                        ...
                                        <div class="info_upload">
                                            <div class="info_upload_square">
                                                <div class="info_gen_img">
                                                    <img src="./img/talls_img/hehe.png" alt="">
                                                </div>    
                                            </div>
                                        <button class="up_accpic">上傳頭像</button> 
                                        </div>
                                        <form action="member-info-index-got.php" method='post'>

                                                <div class="info_gen02">
                                                    <div class="info_gen_nickname">暱稱</div>
                                                    <input class="acc_input" type="text" id="" name='acc_nickname' value="123" />                                 
                                                </div>

                                                <div class="info_gen03">
                                                    <div class="info_gen_intro">簡介</div>
                                                    <input class="acc_input" type="text" name='acc_intro' value="testtest">                                
                                                </div>
                    ...
                    <div class="footer">
                        ...
                        <div class="credit-card">
                                <ul class="list-unstyled d-flex justify-content-center ott-platform">
                                    <a href="#"><li class="mr-2"><img src="../img/logo/netflix.svg" alt=""></li></a>
                                    <a href="#"><li class="mr-2"><img src="../img/logo/IQiyi.svg" alt=""></li></a>
                                    <a href="#"><li class="mr-2"><img src="../img/talls_img/kktv (1).svg" alt=""></li></a>
                                    <a href="#"><li class="f-ott"><img src="../img/talls_img/friday.svg" alt=""></li></a>
