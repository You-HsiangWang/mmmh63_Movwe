...
CREATE TABLE `forum_comment` (
  ...
  `f_comment_authur` int(11) NOT NULL COMMENT '該留言的作者',
...
INSERT INTO `forum_comment` (`f_comment_sid`, `f_comment_content`, `f_comment_forum_sid`, `f_comment_authur`, `f_comment_uploadtime`, `f_comment_likes`) VALUES
(1, '我愛辣妹 辣妹愛我', 1, 1, '2022-06-03 07:22:43', 10);
...
--
ALTER TABLE `forum_comment`
  MODIFY `f_comment_sid` int(11) NOT NULL AUTO_INCREMENT COMMENT '留言sid', AUTO_INCREMENT=2;
COMMIT;
